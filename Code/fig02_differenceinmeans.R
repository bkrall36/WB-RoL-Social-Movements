...
dftable <- data.frame(pml_table)
png("differenceinmeans_pml_2008DiD.png")
p<-tableGrob(dftable)
grid.arrange(p)
dev.off()
...
dftable <- data.frame(pmln_table)
png("differenceinmeans_pmln_2008DiD.png")
p<-tableGrob(dftable)
grid.arrange(p)
dev.off()
...
dftable <- data.frame(pml_table)
png("differenceinmeans_ppp_2008DiD.png")
p<-tableGrob(dftable)
grid.arrange(p)
dev.off()